clear all
% Script based on the original work provided by Hydroflux AB.
% Modified by Elias Olofsson. 
% 
% Changelog:
% 	v2.0 2022-01-14: 
%	Changed order of operations such to make flush connections with settling
%	chamber and test section of predetermined widths. Now CR is determined by 
%	the ratio of Di to Do, where in the previous version, Di where allowed
%	to vary to fit a certain specified value of CR. 
%
